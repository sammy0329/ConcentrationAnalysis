...
def main(config_path):
    ...
    from trainers.tta_trainer import MyTrainer

    # from trainers.centerloss_trainer import FER2013Trainer
    trainer = MyTrainer(model, train_set, val_set, test_set, configs)
...
def get_dataset(configs):
    ...
    """
    from utils.datasets.mydataset import mixdata

    # todo: add transform
    train_set = mixdata("train", configs)
    val_set = mixdata("val", configs)
    test_set = mixdata("test", configs, tta=True, tta_size=10)
